...
public class ScenarioController {
    ...
    public OrderWithItems getOrderWithItems(@PathVariable Long id) {
    ...
    @GetMapping("/products")
    public List<ProductRecord> getProducts(@RequestParam(required=false) Long categoryId,
    ...
    public OrdersRecord createOrderBatch(@RequestParam(name="count", defaultValue="10") int count) {
    ...
    public OrdersRecord createOrderTransactional(@RequestBody OrderRequest request) {
